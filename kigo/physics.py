...
# ✅ Qt shim (QtPy behind it; PySide-first then PyQt)
from kigo.qt import QtCore

QTimer = QtCore.QTimer
QObject = QtCore.QObject
pyqtSignal = QtCore.Signal  # keep old name so existing code stays unchanged
...
class PhysicsEngine(QObject):
    ...
    Qt event loop (PySide/PyQt via QtPy shim).
    """
    ...
    def spawn_object(
        ...
        if shape == "cube":
            ...
            # NOTE: For spheres, Bullet expects radius.
            geom = p.GEOM_SPHERE
            radius = 0.5
